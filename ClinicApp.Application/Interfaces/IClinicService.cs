...
public interface IClinicService
{
    ...
    Task<PagedResult<PatientDto>> GetPatientsAsync(string? search = null, int page = 1, int? pageSize = null, string? sortBy = "fullName", bool descending = false);
    ...
    Task<PagedResult<DoctorDto>> GetDoctorsAsync(int page = 1, int? pageSize = null, string? sortBy = "fullName", bool descending = false);
    Task<IReadOnlyList<DoctorDto>> LookupDoctorsAsync(string? query = null, int? limit = null);
    Task<PagedResult<AppointmentDto>> GetAppointmentsAsync(DateTime? startDate = null, DateTime? endDate = null, Guid? doctorId = null, AppointmentStatus? status = null, int page = 1, int? pageSize = null, string? sortBy = "startTime", bool descending = false);
    ...
    Task<PagedResult<InvoiceDto>> GetInvoicesAsync(Guid? patientId = null, InvoiceStatus? status = null, int page = 1, int? pageSize = null, string? sortBy = "invoiceDate", bool descending = true);
